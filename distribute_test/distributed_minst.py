...
@author  : zengqingxue
#@file   : distribute_cnn.py
#@ide    : PyCharm
#@time   : 2022-05-07 14:34:13
'''
# encoding:utf-8
import math
import tempfile
...
# https://blog.csdn.net/zwahut/article/details/90637793
...
flags.DEFINE_string('ps_hosts', '192.168.1.219:22221', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', '192.168.1.219:22222,192.168.1.219:22223',
