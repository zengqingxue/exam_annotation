...
def gen_training_data(raw_data_path):
    label_list = [line.strip() for line in open(config.label_file_name, 'r', encoding='utf8')]
    print(label_list)
...
def gen_sample_base_template():
    ...
    disease_list = json.load(
        open('../../knowledge_extraction/bilstm_crf/checkpoint/diseases.json', 'r', encoding='utf8'))
